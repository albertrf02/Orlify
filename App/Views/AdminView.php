...
<body>
            ...
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    <button type="button" class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
                        ...
                        <span id="orles-edit" class="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap">Orles</span>
                    </button>
                </li>
            </ul>
        </div>
    ...
    <div class="p-4 sm:ml-64 min-h-screen bg-background">
        <div class="p-4 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
            <div id="search-users-edit" class="flex items-center justify-center">
            ...
            <div id="pagina-classes-add" class="pagina hidden">
                <div class="grid gap-4">
                    <form class="border-2 mb-8 p-4 bg-white rounded-lg" action="/adduserclass" method="POST">
                        <div class="mb-8">
                            <p class="mb-2 text-lg font-medium text-gray-900 dark:text-gray-300">Classes</p>
            ...
            <div id="pagina-orles-edit" class="pagina hidden">
                <div class="border-2 mb-8 p-4 bg-white rounded-lg">
                <button data-modal-target="authentication-modal" data-modal-toggle="authentication-modal" class="block text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 mb-4" type="button">Crear Orla</button>
                                ...
                                <div class="flex items-center mb-2">
                                    <div class="ml-auto">
                                        <label class="relative inline-flex items-center cursor-pointer">
                                            <input type="checkbox" value="<?= $orla['id']; ?>" class="sr-only peer" onchange="toggleOrlaPublic(this)" <?= $orla['public'] == 1 ? 'checked' : ''; ?>>
                                            <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600"></div>
                                        </label>
                                    </div>
                                </div>
                                <div class="flex items-end">
                                    <p class="text-lg font-medium text-gray-900 dark:text-white"><?= $orla['name']; ?></p>
                                    <div class="ml-16">
                                        <a href="/orla/edit?idOrla=<?= $orla['id'] ?>" class="edit-button text-white bg-gray-400 hover:bg-blue-400 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-700 font-medium rounded-lg text-sm inline-flex items-end px-5 py-2 text-center">
                                        ...
                                        <button data-modal-target="delete-modal-<?= $orla['id']; ?>" data-modal-toggle="delete-modal-<?= $orla['id']; ?>" class="delete-button text-white bg-gray-400 hover:bg-red-400 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-end px-5 py-2 text-center">
                                            <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 20">
                                                <path d="M17 4h-4V2a2 2 0 0 0-2-2H7a2 2 0 0 0-2 2v2H1a1 1 0 0 0 0 2h1v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V6h1a1 1 0 1 0 0-2ZM7 2h4v2H7V2Zm1 14a1 1 0 1 1-2 0V8a1 1 0 0 1 2 0v8Zm4 0a1 1 0 0 1-2 0V8a1 1 0 0 1 2 0v8Z" />
                                            </svg>
                                        </button>
                                        <?php if ($orla['visibility'] == 0): ?>
                                            <a href="/equipDirectiu?action=activateOrla&idOrla=<?= $orla['id']; ?>" class="edit-button text-white bg-gray-400 hover:bg-blue-400 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-700 font-medium rounded-lg text-sm inline-flex items-end px-5 py-2 text-center">
                                        ...
                                        <?php else: ?>
                                            <a href="/admin?action=deactivateOrla&idOrla=<?= $orla['id']; ?>" class="delete-button text-white bg-gray-400 hover:bg-red-400 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-end px-5 py-2 text-center">
                                        ...
                                        <?php endif ?>
                                        <div id="delete-modal-<?= $orla['id']; ?>" tabindex="-1" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                                            <div class="absolute inset-0 bg-black opacity-50"></div>
                                                <div class="relative p-4 w-full max-w-md max-h-full">
                                                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                        <button type="button" class="absolute top-3 end-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="delete-modal-<?= $orla['id']; ?>">
                                                    ...
                                                    <div class="p-4 md:p-5 text-center">
                                                        ...
                                                        <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Segur que vols borrar l'orla?</h3>
                                                        <div class="p-4 md:p-5 text-center">
                                                            <div class="flex justify-center mt-2">
                                                                <a href="/admin?action=deleteOrla&idOrla=<?= $orla['id']; ?>" class="delete-button mr-2 text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-3 text-center me-2">Borrar</a>
                                                                <button data-modal-hide="delete-modal-<?= $orla['id']; ?>" type="button" class="cancel-button text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600">Cancelar
                                                                </button>
                                                            </div>
                                                        </div>
                                                    </div>
    ...
    <div id="authentication-modal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
        <div class="relative p-4 w-full max-w-md max-h-full">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                    <h3 class="text-xl font-semibold text-gray-900 dark:text-white">Nova Orla</h3>
                ...
                <div class="p-4 md:p-5">
                    <form class="space-y-4" method="POST" action="/equipDirectiu?action=createOrla">
                        <div>
                            <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nom del'orla</label>
                        ...
                        <label for="group" class="block text-sm font-medium text-gray-700">Seleccionar Grup</label>
                        <div class="relative mt-1">
                            <select id="group" name="group" class="block appearance-none w-full bg-white border border-gray-300 hover:border-gray-400 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline-blue focus:border-blue-300">
                        ...
                        <button type="submit" class="w-full flex items-center justify-center text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                            Crear Orla
