...
<div class="p-4 sm:ml-64">
    <div id="bienvenida" class="pagina mt-16">
        <!-- Contenido de bienvenida -->
        <h2>Bienvenido</h2>
        <p>Gracias por visitar nuestro sitio. Este es un mensaje de bienvenida.</p>
        <!-- Agrega aquí cualquier otro contenido de bienvenida que desees mostrar -->
    </div>
    
    <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700">
        <div id="pagina-users" class="pagina" style="display: none;">
            <!-- Contenido para la página "Users" -->
            <h2>Contenido de Users</h2>
            <p>Esta es la información de la página "Users".</p>
        </div>

        <div id="pagina-classes" class="pagina" style="display: none;">
            <!-- Contenido para la página "Classes" -->
