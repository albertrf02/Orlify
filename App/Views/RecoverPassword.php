...
<body class="bg-background">
    <div class="min-h-screen flex items-center justify-center">
        <div class="bg-white p-5 rounded shadow-md w-full sm:w-96">
            <form class="max-w-sm mx-auto" action="/dorecoverpassword" method="post">
                ...
                <div class="flex mb-4">
                    ...
                    <input type="password" name="repeat_password" id="website-adminn-repeat" class="rounded-none rounded-e-lg bg-gray-50 border border-gray-300 text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Repeteix contrasenya">
                </div>
