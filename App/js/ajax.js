              ...
              users.forEach(function (user) {
                var userHtml = `
                            ...
                            <div class="flex flex-col items-center pb-10">
                                <img class="w-24 h-24 mb-3 rounded-full shadow-lg" src= "../avatars/"${
                                  user.avatar
                                }" alt="${user.name}"/>
                                ...
                                <div class="flex mt-4 md:mt-6">
                                    <div class="mr-4">
                                        <button data-edit-user-id="${
                                          user.id
                                        }" data-modal-target="editUserModal" data-modal-show="editUserModal" class="editUserModal block text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-3 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button">
                                    ...
                                    <div>
                                        <button data-delete-user-id="${
                                          user.id
                                        }" data-modal-target="deleteUserModal" data-modal-show="deleteUserModal" class="deleteUserModal block text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-3 py-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800" type="button">
                                            <svg class="w-6 h-6" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
            ...
            success: function (data) {
                                            ...
                                            <li class="flex items-center justify-between p-5 border border-gray-200 rounded-lg">
                                                ...
                                                <div class="flex items-center">
                                                    <input id="default-checkbox-${
                                                      user.id
                                                    }" type="checkbox" name="selectedUsers[]" value="${
                  user.id
                }" ${
                  isChecked ? "checked" : ""
              ...
              $submitButton.on("click", function (e) {
                ...
                if (selectedUserIds.length > 0) {
                  ...
                  console.log(
                    "Formulario enviado con usuarios seleccionados: ",
                    selectedUserIds
                  );
                  // Agregar aquí la lógica para enviar el formulario si es necesario
                } else {
                  console.log(
                    "No hay usuarios seleccionados. No se enviará el formulario."
                  );
                }
              });
            },
                                          ...
                                          user.email
                                                ...
                                                <div class="flex mt-4 md:mt-6">
                                                    <a href="#" type="button" data-edit-user-id="${
                                                      user.id
                                                    }" data-modal-target="editUserModal" data-modal-show="editUserModal" class="editUserModal inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Dades</a>
                                                </div>
                                            </div>
                                        </div>
                                `;
